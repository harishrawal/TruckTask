...
class VehicleYearMFSpinnerAdapter(context: Context, dataList: List<ManufactureYear>) : ArrayAdapter<ManufactureYear>(context, 0, dataList) {
    ...
    private fun initView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val fuelItem:ManufactureYear = getItem(position) as ManufactureYear
