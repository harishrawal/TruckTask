...
class VehicleMakeSpinnerAdapter(context: Context, dataList: List<VehicleMake>) : ArrayAdapter<VehicleMake>(context, 0, dataList) {
    ...
    private fun initView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val fuelItem:VehicleMake = getItem(position) as VehicleMake
